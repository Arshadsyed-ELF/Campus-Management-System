...
const Complaints = () => {
  ...
  return (
    ...
    <Sidebar/>
        ...
        <div className="container mt-5">      <h2 className="mb-4" >Complaints </h2>
          ...
          <div key={classroom._id} className="grid-item">
            <div className="classroom-info">  
              ...
              {/* <Button ><Link to={`/classdetails/${classroom._id}`} style={{color:"white",textDecoration:"none"}}>open</Link></Button> */}
                  <Button variant="danger" onClick={()=>{deleteData(classroom._id)}}style={{marginLeft:"0px"}}>Resolve</Button>
